package com.hjq.widget.titlebar;
...
final class ViewBuilder {
    ...
    ViewBuilder(Context context) {
        ...
        mMainLayout.setId(R.id.widget_bar_id_main_layout);
        ...
        mLeftView.setId(R.id.widget_bar_id_left_view);
        ...
        mTitleView.setId(R.id.widget_bar_id_title_view);
        ...
        mRightView.setId(R.id.widget_bar_id_right_view);
        ...
        mLineView.setId(R.id.widget_bar_id_line_view);
